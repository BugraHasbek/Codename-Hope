...
namespace rendering
{
	...
	public:
		...
		void     update(sf::Vector2i mousePos);	// TODO: still not too happy with this function. in the future we might add zoom. We can overload same function name with different arguments perhaps?
